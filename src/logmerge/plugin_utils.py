...
def validate_timestamp_field(schema_data: Dict[str, Any]) -> None:
    ...
    if timestamp_field_def and timestamp_field_def['type'] not in ['epoch', 'strptime', 'float_timestamp']:
        raise ValueError(f"timestamp_field '{timestamp_field}' must be of type 'epoch', 'strptime', or 'float_timestamp'")
