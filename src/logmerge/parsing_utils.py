...
def convert_field_value(raw_value: str, field: Dict[str, Any], enum_lookups: Dict[str, Dict[int, str]]) -> Any:
    ...
    Args:
        ...
        enum_lookups: Pre-built enum lookup dictionaries for performance
    ...
    if field_type == 'string':
        ...
        if not strptime_fmt:
            raise ValueError(f"Field {field['name']} uses 'strptime' but missing 'strptime_fmt'")
...
def parse_line_with_regex(raw_line: str, schema: LogParsingPlugin) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        for field in schema.fields:
            ...
            try:
                ...
                converted_value = convert_field_value(raw_value, field, schema.enum_lookups)
